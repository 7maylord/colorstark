    ...
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50 bg-black bg-opacity-60 animate-fade-in">
      <div className="relative flex flex-col items-center gap-2 p-3 sm:gap-3 sm:p-6 bg-white/90 rounded-2xl shadow-2xl border-4 border-purple-500 animate-bounce-in w-[96vw] max-w-[98vw] sm:max-w-[400px] md:max-w-[35vw]">
        ...
        <ul className="text-sm sm:text-base text-gray-800 text-left list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-2">
          <li><span className="font-bold text-purple-500">Register your name</span> before playing the game!</li>
          <li>If the game is too hard, <span className="font-bold text-blue-500">you can <span className='underline'>peek</span> at the target</span>... but we won't tell anyone! 😉</li>
